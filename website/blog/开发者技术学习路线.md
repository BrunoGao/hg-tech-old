...
tags: ["学习路线"]
summary: >-
  这是一个提供全方位开发者技术学习路线的项目，包含多种开发方向、编程语言和技术。根据角色或技能选择具体路线，如后端开发、Java技术栈，学习内容涵盖网络、数据库、缓存等。该项目支持分享、下载思维导图并标注学习状态。地址：https://github.com/kamranahmedse/developer-roadmap。
---
